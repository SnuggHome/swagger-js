...
"use strict";var _={cloneDeep:require("lodash-compat/lang/cloneDeep"),isUndefined:require("lodash-compat/lang/isUndefined")},helpers=require("../helpers"),Model=require("./model"),SwaggerHttp=require("../http"),Operation=module.exports=function(e,t,r,s,i,n,o,a,p){var l=[];if(e=e||{},n=n||{},e&&e.options&&(this.client=e.options.client||null,this.responseInterceptor=e.options.responseInterceptor||null),this.authorizations=n.security,this.basePath=e.basePath||"/",this.clientAuthorizations=p,this.consumes=n.consumes||e.consumes||["application/json"],this.produces=n.produces||e.produces||["application/json"],this.deprecated=n.deprecated,this.description=n.description,this.host=e.host||"localhost",this.method=s||l.push("Operation "+r+" is missing method."),this.models=a||{},this.nickname=r||l.push("Operations must have a nickname."),this.operation=n,this.operations={},this.parameters=null!==n?n.parameters||[]:{},this.parent=e,this.path=i||l.push("Operation "+this.nickname+" is missing path."),this.responses=n.responses||{},this.scheme=t||e.scheme||"http",this.schemes=e.schemes,this.security=n.security,this.summary=n.summary||"",this.type=null,this.useJQuery=e.useJQuery,this.parameterMacro=e.parameterMacro||function(e){return e.default},this.inlineModels=[],"string"==typeof this.deprecated)switch(this.deprecated.toLowerCase()){case"true":case"yes":case"1":this.deprecated=!0;break;case"false":case"no":case"0":case null:this.deprecated=!1;break;default:this.deprecated=Boolean(this.deprecated)}var u,h;if(o){var d;for(d in o)(h=new Model(d,o[d],this.models,e.modelPropertyMacro))&&(this.models[d]=h)}for(u=0;u<this.parameters.length;u++){var c=this.parameters[u];c.default=this.parameterMacro(c),"array"===c.type&&(c.isList=!0,c.allowMultiple=!0,c.items&&c.items.enum&&(c.enum=c.items.enum));var m=this.getType(c);if(m&&"boolean"===m.toString().toLowerCase()&&(c.allowableValues={},c.isList=!0,c.enum=[!0,!1]),void 0!==c.enum){var f;for(c.allowableValues={},c.allowableValues.values=[],c.allowableValues.descriptiveValues=[],f=0;f<c.enum.length;f++){var y=c.enum[f],v=y===c.default||y+""===c.default;c.allowableValues.values.push(y),c.allowableValues.descriptiveValues.push({value:y+"",isDefault:v})}}if("array"===c.type&&(m=[m],void 0===c.allowableValues&&(delete c.isList,delete c.allowMultiple)),void 0===c.type){var g=c.schema;g&&g.$ref&&(h=this.models[helpers.simpleRef(g.$ref)])&&h.definition.title&&(c.type=h.definition.title)}c.signature=this.getModelSignature(m,this.models).toString(),c.sampleJSON=this.getModelSampleJSON(m,this.models),c.responseClassSignature=c.signature}var b,O,M=this.responses;if(M[200]?(O=M[200],b="200"):M[201]?(O=M[201],b="201"):M[202]?(O=M[202],b="202"):M[203]?(O=M[203],b="203"):M[204]?(O=M[204],b="204"):M[205]?(O=M[205],b="205"):M[206]?(O=M[206],b="206"):M.default&&(O=M.default,b="default"),O&&O.schema){var P,C=this.resolveModel(O.schema,o);delete M[b],C?(this.successResponse={},P=this.successResponse[b]=C):O.schema.type&&"object"!==O.schema.type&&"array"!==O.schema.type?(this.successResponse={},P=this.successResponse[b]=O.schema):(this.successResponse={},P=this.successResponse[b]=new Model(void 0,O.schema||{},this.models,e.modelPropertyMacro)),P&&(O.description&&(P.description=O.description),O.examples&&(P.examples=O.examples),O.headers&&(P.headers=O.headers)),this.type=O}return l.length>0&&this.resource&&this.resource.api&&this.resource.api.fail&&this.resource.api.fail(l),this};Operation.prototype.isDefaultArrayItemValue=function(e,t){return t.default&&Array.isArray(t.default)?-1!==t.default.indexOf(e):e===t.default},Operation.prototype.getType=function(e){var t,r=e.type,s=e.format,i=!1;"integer"===r&&"int32"===s?t="integer":"integer"===r&&"int64"===s?t="long":"integer"===r?t="integer":"string"===r?t="date-time"===s?"date-time":"date"===s?"date":"string":"number"===r&&"float"===s?t="float":"number"===r&&"double"===s?t="double":"number"===r?t="double":"boolean"===r?t="boolean":"array"===r&&(i=!0,e.items&&(t=this.getType(e.items))),e.$ref&&(t=helpers.simpleRef(e.$ref));var n=e.schema;if(n){var o=n.$ref;return o?(o=helpers.simpleRef(o),i?[o]:o):"object"===n.type?this.addInlineModel(n):this.getType(n)}return i?[t]:t},Operation.prototype.addInlineModel=function(e){var t=this.inlineModels.length,r=this.resolveModel(e,{});return r?(this.inlineModels.push(r),"Inline Model "+t):null},Operation.prototype.getInlineModel=function(e){if(/^Inline Model \d+$/.test(e)){var t=parseInt(e.substr("Inline Model".length).trim(),10);return this.inlineModels[t]}return null},Operation.prototype.resolveModel=function(e,t){if(void 0!==e.$ref){var r=e.$ref;if(0===r.indexOf("#/definitions/")&&(r=r.substring("#/definitions/".length)),t[r])return new Model(r,t[r],this.models,this.parent.modelPropertyMacro)}else if(e&&"object"==typeof e&&("object"===e.type||_.isUndefined(e.type)))return new Model(void 0,e,this.models,this.parent.modelPropertyMacro);return null},Operation.prototype.help=function(e){for(var t=this.nickname+": "+this.summary+"\n",r=0;r<this.parameters.length;r++){var s=this.parameters[r],i=s.signature;t+="\n  * "+s.name+" ("+i+"): "+s.description}return void 0===e&&helpers.log(t),t},Operation.prototype.getModelSignature=function(e,t){var r,s;return e instanceof Array&&(s=!0,e=e[0]),void 0===e?(e="undefined",r=!0):t[e]?(e=t[e],r=!1):this.getInlineModel(e)?(e=this.getInlineModel(e),r=!1):r=!0,r?s?"Array["+e+"]":e.toString():e.getMockSignature()},Operation.prototype.supportHeaderParams=function(){return!0},Operation.prototype.supportedSubmitMethods=function(){return this.parent.supportedSubmitMethods},Operation.prototype.getHeaderParams=function(e){for(var t=this.setContentTypes(e,{}),r=0;r<this.parameters.length;r++){var s=this.parameters[r];if(void 0!==e[s.name]&&"header"===s.in){var i=e[s.name];Array.isArray(i)&&(i=i.toString()),t[s.name]=i}}return t},Operation.prototype.urlify=function(e){for(var t={},r=this.path,s="",i=0;i<this.parameters.length;i++){var n=this.parameters[i];if(void 0!==e[n.name])if("path"===n.in){var o=new RegExp("{"+n.name+"}","gi"),a=e[n.name];a=Array.isArray(a)?this.encodePathCollection(n.collectionFormat,n.name,a):this.encodePathParam(a),r=r.replace(o,a)}else if("query"===n.in&&void 0!==e[n.name])if(s+=""===s?"?":"&",void 0!==n.collectionFormat){var p=e[n.name];Array.isArray(p)?s+=this.encodeQueryCollection(n.collectionFormat,n.name,p):s+=this.encodeQueryParam(n.name)+"="+this.encodeQueryParam(e[n.name])}else s+=this.encodeQueryParam(n.name)+"="+this.encodeQueryParam(e[n.name]);else"formData"===n.in&&(t[n.name]=e[n.name])}var l=this.scheme+"://"+this.host;return"/"!==this.basePath&&(l+=this.basePath),l+r+s},Operation.prototype.getMissingParams=function(e){var t,r=[];for(t=0;t<this.parameters.length;t++){var s=this.parameters[t];!0===s.required&&void 0===e[s.name]&&(r=s.name)}return r},Operation.prototype.getBody=function(e,t,r){for(var s,i,n,o={},a=!1,p=0;p<this.parameters.length;p++){var l=this.parameters[p];void 0!==t[l.name]?"body"===l.in?s=t[l.name]:"formData"===l.in&&(o[l.name]=t[l.name]):"body"===l.in&&(a=!0)}if(a&&void 0===s){var u=e["Content-Type"];u&&0===u.indexOf("application/json")&&(s="{}")}if("application/x-www-form-urlencoded"===e["Content-Type"]){var h="";for(i in o)void 0!==(n=o[i])&&(""!==h&&(h+="&"),h+=encodeURIComponent(i)+"="+encodeURIComponent(n));s=h}else if(e["Content-Type"]&&e["Content-Type"].indexOf("multipart/form-data")>=0&&r.useJQuery){var d=new FormData;d.type="formData";for(i in o)void 0!==(n=t[i])&&("file"===n.type&&n.value?(delete e["Content-Type"],d.append(i,n.value)):d.append(i,n));s=d}return s},Operation.prototype.getModelSampleJSON=function(e,t){var r,s,i;if(t=t||{},r=e instanceof Array,i=r?e[0]:e,t[i]?s=t[i].createJSONSample():this.getInlineModel(i)&&(s=this.getInlineModel(i).createJSONSample()),s){if("string"==typeof(s=r?[s]:s))return s;if("object"==typeof s){var n=s;if(s instanceof Array&&s.length>0&&(n=s[0]),n.nodeName){var o=(new XMLSerializer).serializeToString(n);return this.formatXml(o)}return JSON.stringify(s,null,2)}return s}},Operation.prototype.do=function(e,t,r,s,i){return this.execute(e,t,r,s,i)},Operation.prototype.execute=function(e,t,r,s,i){var n,o,a=e||{},p={};"object"==typeof t&&(p=t,n=r,o=s),this.client&&(p.client=this.client),this.responseInterceptor&&(p.responseInterceptor=this.responseInterceptor),"function"==typeof t&&(n=t,o=r),n=n||this.parent.defaultSuccessCallback||helpers.log,o=o||this.parent.defaultErrorCallback||helpers.log,void 0===p.useJQuery&&(p.useJQuery=this.useJQuery);var l=this.getMissingParams(a);if(l.length>0){var u="missing required params: "+l;return helpers.fail(u),void o(u)}var h,d=this.getHeaderParams(a),c=this.setContentTypes(a,p),m={};for(h in d)m[h]=d[h];for(h in c)m[h]=c[h];var f=this.getBody(c,a,p),y=this.urlify(a);if(y.indexOf(".{format}")>0&&m){var v=m.Accept||m.accept;v&&v.indexOf("json")>0?y=y.replace(".{format}",".json"):v&&v.indexOf("xml")>0&&(y=y.replace(".{format}",".xml"))}var g={url:y,method:this.method.toUpperCase(),body:f,useJQuery:p.useJQuery,headers:m,on:{response:function(e){return n(e,i)},error:function(e){return o(e,i)}}};if(this.clientAuthorizations.apply(g,this.operation.security),!0===p.mock)return g;(new SwaggerHttp).execute(g,p)},Operation.prototype.setContentTypes=function(e,t){var r,s,i=this.parameters,n=e.parameterContentType||this.consumes[0],o=t.responseContentType||this.produces[0],a=[],p=[],l={};for(s=0;s<i.length;s++){var u=i[s];if("formData"===u.in)"file"===u.type?a.push(u):p.push(u);else if("header"===u.in&&t){var h=u.name,d=t[u.name];void 0!==t[u.name]&&(l[h]=d)}else"body"===u.in&&void 0!==e[u.name]&&(r=e[u.name])}return"post"===this.method||"put"===this.method||"patch"===this.method?(t.requestContentType&&(n=t.requestContentType),p.length>0&&(n=t.requestContentType?t.requestContentType:a.length>0?"multipart/form-data":"application/x-www-form-urlencoded")):n=null,n&&this.consumes&&-1===this.consumes.indexOf(n)&&helpers.log("server doesn't consume "+n+", try "+JSON.stringify(this.consumes)),o&&this.produces&&-1===this.produces.indexOf(o)&&helpers.log("server can't produce "+o),(n&&""!==r||"application/x-www-form-urlencoded"===n)&&(l["Content-Type"]=n),o&&(l.Accept=o),l},Operation.prototype.asCurl=function(e){var t=this.execute(e,{mock:!0});this.clientAuthorizations.apply(t);var r=[];if(r.push("-X "+this.method.toUpperCase()),t.headers){var s;for(s in t.headers)r.push('--header "'+s+": "+t.headers[s]+'"')}if(t.body){var i;i="object"==typeof t.body?JSON.stringify(t.body):t.body,r.push('-d "'+i.replace(/"/g,'\\"')+'"')}return"curl "+r.join(" ")+' "'+t.url+'"'},Operation.prototype.encodePathCollection=function(e,t,r){var s,i="",n="";for(n="ssv"===e?"%20":"tsv"===e?"\\t":"pipes"===e?"|":",",s=0;s<r.length;s++)0===s?i=this.encodeQueryParam(r[s]):i+=n+this.encodeQueryParam(r[s]);return i},Operation.prototype.encodeQueryCollection=function(e,t,r){var s,i="";if("default"===e||"multi"===e)for(s=0;s<r.length;s++)s>0&&(i+="&"),i+=this.encodeQueryParam(t)+"="+this.encodeQueryParam(r[s]);else{var n="";if("csv"===e)n=",";else if("ssv"===e)n="%20";else if("tsv"===e)n="\\t";else if("pipes"===e)n="|";else if("brackets"===e)for(s=0;s<r.length;s++)0!==s&&(i+="&"),i+=this.encodeQueryParam(t)+"[]="+this.encodeQueryParam(r[s]);if(""!==n)for(s=0;s<r.length;s++)0===s?i=this.encodeQueryParam(t)+"="+this.encodeQueryParam(r[s]):i+=n+this.encodeQueryParam(r[s])}return i},Operation.prototype.encodeQueryParam=function(e){return encodeURIComponent(e)},Operation.prototype.encodePathParam=function(e){var t,r,s,i;if(e=e.toString(),-1===e.indexOf("/"))return encodeURIComponent(e);for(r=e.split("/"),t=[],s=0,i=r.length;s<i;s++)t.push(encodeURIComponent(r[s]));return t.join("/")};
...
(function (Buffer){
!function(){"use strict";function r(r){var t;return t=r instanceof Buffer?r:Buffer.from(r.toString(),"binary"),t.toString("base64")}module.exports=r}();
