        ...
        if (_.isPlainObject(schema.properties)) {
          html += _.map(schema.properties, function (property, name) {
            ...
            if (property.minimum !== undefined) {
              html += '<br /><span class="propMin">Min: ' + property.minimum + '</span>'
            }

            if (property.maximum !== undefined) {
              html += '<br /><span class="propMax">Max: ' + property.maximum + '</span>'
            }

            if (property.precision !== undefined) {
              html += '<br /><span class="propPrecision">Precision: ' + property.precision + '</span>'
            }
